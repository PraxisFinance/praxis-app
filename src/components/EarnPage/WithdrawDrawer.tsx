...
{/* 
              <p className="text-main-darkPurple/80 text-sm font-normal leading-5">
                Early withdrawal will burn your generated yield.
              </p> */}
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-main-grayPurple rounded-[10px] flex items-center px-4 py-3 gap-2">
                ...
                />
                <button
                  onClick={() => setAmount(availableAmount.replace(/,/g, ""))}
                  className="px-4 py-1.5 bg-main-lightGray rounded-[6px] text-main-darkPurple text-sm leading-4 transition-transform active:scale-[0.97]"
                >
                  Max
                </button>
              </div>
