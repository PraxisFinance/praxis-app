...
import { ProgressInfoDrawer } from "@/components/ProgressPage/drawers/ProgressInfoDrawer";
import { ProgressBar } from "@/components/ui/ProgressBar";
import { ACHIEVEMENTS_PROGRESS_INFO_DRAWER } from "@/shared/constants/progressInfoDrawers";
  ...
  return (
    <>
      ...
      <ProgressInfoDrawer
        ...
        title={ACHIEVEMENTS_PROGRESS_INFO_DRAWER.title}
        paragraphs={ACHIEVEMENTS_PROGRESS_INFO_DRAWER.paragraphs}
      />
    </>
  );
}
