...
import type { SportHubMatchTeam } from "@/shared/types/sportHubMatch";
import { getEsportsTeamInitials } from "@/shared/utils/esportsTeamDisplay";
import { cn } from "@/lib/utils";

interface SportMatchDrawerTeamInlineProps {
  team: SportHubMatchTeam;
}

export function SportMatchDrawerTeamInline({ team }: SportMatchDrawerTeamInlineProps) {
