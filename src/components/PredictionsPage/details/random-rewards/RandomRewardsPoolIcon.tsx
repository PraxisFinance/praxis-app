...
export interface RandomRewardsPoolIconProps {
  iconUrl?: string;
  /** Used for image `alt` (e.g. pool title). */
  alt: string;
  variant: RandomRewardsPoolIconVariant;
}

export function RandomRewardsPoolIcon({ iconUrl, alt, variant }: RandomRewardsPoolIconProps) {
