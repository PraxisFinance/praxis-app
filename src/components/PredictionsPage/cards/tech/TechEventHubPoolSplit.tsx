  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex items-center justify-between text-2xs tabular-nums">
        <span className="text-main-red font-semibold">{formatTechPoolPercent(yes.poolPercent)}</span>
        <span className="text-main-darkPurple font-semibold">{formatTechPoolPercent(no.poolPercent)}</span>
      </div>
    </div>
  );
}
