...
export const isSportEvent = (event: Event): event is SportEvent => 
  event.type === 'sport';

export const isEconomicEvent = (event: Event): event is EconomicEvent => 
  event.type === 'economic';

export const isRandomEvent = (event: Event): event is RandomEvent => 
  event.type === 'random';
